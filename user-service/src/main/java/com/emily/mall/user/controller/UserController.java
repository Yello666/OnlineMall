...
import com.emily.mall.user.dto.UserVo;
...
public class UserController {
    ...
    //用户余额支付
    @PostMapping("/pay")
    public Result<Boolean> payByUserBalance(@RequestParam BigDecimal amount){
        Long userId=getCurrentUserIdSafely();
        log.debug("userId:{}",userId);
        return userService.payByUserBalance(amount,userId);
    }
